...
// ----------------------------------------------------------
//Okay. Now it's correct. and it includes logic - and vice versa.
function validate48_005() {
    // Verifică dacă e bifat Rândul 1.7.1 COL1
    var r171_checked = jQuery('#CAPITOL1_R171_C1').is(':checked');

    // Verifică dacă toate câmpurile 1.7.2 și 1.7.3 sunt nebifate
    ...
    var r172_empty = !r172_c1 && !r172_c2;
    var r173_empty = !r173_c1 && !r173_c2;

    if (r171_checked && r172_empty && r173_empty) {
        webform.errors.push({
