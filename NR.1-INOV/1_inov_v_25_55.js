...
//Aceasta lucreaza. Dar trebuie de aplicat pentru toate trei
//Modifica aceatsa afișare vizuală sub câmp 
function watchR134LiveValidation() {
    jQuery('#CAPITOL1_R134_C1').on('input', function () {
        let val = parseInt(jQuery(this).val(), 10);
        if (!isNaN(val) && val !== 100) {
            alert("Cod eroare: 48-004\nValoarea introdusă în Rândul 1.8.4 trebuie să fie exact 100%");
        }
    });
}
