...
//---------------------------------------------
//Analyze the html and js files
//Modify these two functions - when the condition is - true - do not hide anything but make the variables read only
//Modifica aceste doua functii -  cand  conditia este - true - nu ascunde nimic dar variabilile sa fie read only 
    ...
    jQuery('input[type=checkbox]').change(function () {
        if (
             ...
             (
                ...
                jQuery('#CAPITOL1_R1111_C2').is(':checked') && jQuery('#CAPITOL1_R1112_C2').is(':checked') 
