(function ($) {
    ...
    Drupal.behaviors.inov1 = {
        attach: function (context, settings) {
            ...
            toggle_111_to_1129_logic4(values); //Toate 1.1–1.7 = NU și 1.10.x = DA Ascunde 1.11–1.12.9, șterge date

            activate_check_111_to_1129_logic4_live(); //
...
function activate_check_111_to_1129_logic4_live() {
    const watchIDs = [
        'CAPITOL1_R111_C2', 'CAPITOL1_R112_C2', 'CAPITOL1_R113_C2',
        'CAPITOL1_R114_C2', 'CAPITOL1_R115_C2', 'CAPITOL1_R116_C2',
        'CAPITOL1_R117_C2',
        'CAPITOL1_R1101_C1', 'CAPITOL1_R1102_C1', 'CAPITOL1_R1103_C1'
    ];

    watchIDs.forEach(id => {
        jQuery(`#${id}`).on('change', check_111_to_1129_logic4);
    });

    check_111_to_1129_logic4(); // rulează inițial
}


function check_111_to_1129_logic4() {
    function isChecked(id) {
        return jQuery(`#${id}`).is(':checked');
    }

    const all_C2_checked = [
        'CAPITOL1_R111_C2', 'CAPITOL1_R112_C2', 'CAPITOL1_R113_C2',
        'CAPITOL1_R114_C2', 'CAPITOL1_R115_C2', 'CAPITOL1_R116_C2',
        'CAPITOL1_R117_C2'
    ].every(isChecked);

    const any_C1_110_checked = [
        'CAPITOL1_R1101_C1', 'CAPITOL1_R1102_C1', 'CAPITOL1_R1103_C1'
    ].some(isChecked);
    ...
    const hideIDs = [
        ...
        '#CAPITOL1_R1125', '#CAPITOL1_R1126', '#CAPITOL1_R1127', '#CAPITOL1_R1128',
        '#CAPITOL1_R1129'
    ];
    ...
    if (all_C2_checked && any_C1_110_checked) {
        hideIDs.forEach(id => jQuery(id).hide());
        ...
        hideIDs.forEach(id => jQuery(id).show());
    }
}


function toggle_111_to_1129_logic4(values) {
    const onlyNoFrom111to117 =
        values.CAPITOL1_R111_C2 == '1' &&
        values.CAPITOL1_R112_C2 == '1' &&
        values.CAPITOL1_R113_C2 == '1' &&
        values.CAPITOL1_R114_C2 == '1' &&
        values.CAPITOL1_R115_C2 == '1' &&
        values.CAPITOL1_R116_C2 == '1' &&
        values.CAPITOL1_R117_C2 == '1';
    ...
    if (onlyNoFrom111to117 && answeredIn110) {
        // Ascunde tot
        hideIDs.forEach(id => jQuery(id).hide());
