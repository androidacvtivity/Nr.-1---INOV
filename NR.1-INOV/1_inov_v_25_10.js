...
function check_all(values) {
    jQuery('input[type=checkbox]').change(function () {
        ...
        // Ensure that CAPITOL1_R191_C1, CAPITOL1_R192_C1, and CAPITOL1_R193_C1 never have one selected
        var specialCases = ["CAPITOL1_R191_C1", "CAPITOL1_R192_C1", "CAPITOL1_R193_C1"];
        if (specialCases.includes(group)) {
            jQuery('input[name="CAPITOL1_R191_C1"], input[name="CAPITOL1_R192_C1"], input[name="CAPITOL1_R193_C1"]').prop('checked', false);
        }
    });
}
